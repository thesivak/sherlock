...
<template>
  <li class="col-span-1 rounded-lg bg-white shadow divide-y divide-gray-200">
    <div class="relative bg-white p-6 group focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
      <div>
